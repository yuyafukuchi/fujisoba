...
class SalesItemHistoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'sales_item_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'sales_item_name' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'start' => '2017-10-02 20:31:08',
            'end' => '2017-10-02 20:31:08',
            'deleted' => 1,
            'created' => '2017-10-02 20:31:08',
            'created_by' => 1,
            'modified' => '2017-10-02 20:31:08',
            'modified_by' => 1
        ],
    ];
}
