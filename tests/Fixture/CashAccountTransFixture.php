...
class CashAccountTransFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'cash_account_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            'id' => 1,
            'store_id' => 1,
            'transaction_date' => '2017-10-02 20:30:30',
            'cash_account_id' => 1,
            'amount' => 1,
            'note' => 'Lorem ipsum dolor sit amet, aliquet feugiat. Convallis morbi fringilla gravida, phasellus feugiat dapibus velit nunc, pulvinar eget sollicitudin venenatis cum nullam, vivamus ut a sed, mollitia lectus. Nulla vestibulum massa neque ut et, id hendrerit sit, feugiat in taciti enim proin nibh, tempor dignissim, rhoncus duis vestibulum nunc mattis convallis.',
            'created' => '2017-10-02 20:30:30',
            'created_by' => 1,
            'modified' => '2017-10-02 20:30:30',
            'modified_by' => 1
        ],
    ];
}
