...
class StoreInventoryItemHistoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'inventory_item_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        ...
        'cost' => ['type' => 'decimal', 'length' => 2, 'precision' => 0, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
    ...
    public $records = [
        [
            ...
            'price' => 1,
            'cost' => 1.5,
            'start' => '2017-10-02 20:31:25',
            'end' => '2017-10-02 20:31:25',
            'deleted' => 1,
            'created' => '2017-10-02 20:31:25',
            'created_by' => 1,
            'modified' => '2017-10-02 20:31:25',
            'modified_by' => 1
        ],
    ];
}
