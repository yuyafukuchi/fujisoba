...
class MenuHistoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'menu_item_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'start' => '2017-10-02 20:30:51',
            'end' => '2017-10-02 20:30:51',
            'deleted' => 1,
            'created' => '2017-10-02 20:30:51',
            'created_by' => 1,
            'modified' => '2017-10-02 20:30:51',
            'modified_by' => 1
        ],
    ];
}
