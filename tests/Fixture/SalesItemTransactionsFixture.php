...
class SalesItemTransactionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'sales_item_price' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        'sales_item_cost' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'sales_item_price' => 1,
            'sales_item_cost' => 1,
            'created' => '2017-10-02 20:31:12',
            'created_by' => 1,
            'modified' => '2017-10-02 20:31:12',
            'modified_by' => 1
        ],
    ];
}
