...
class InventoryItemHistoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'item_name' => ['type' => 'string', 'length' => 100, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'start' => '2017-10-02 20:30:41',
            'end' => '2017-10-02 20:30:41',
            'deleted' => 1,
            'created' => '2017-10-02 20:30:41',
            'created_by' => 1,
            'modified' => '2017-10-02 20:30:41',
            'modified_by' => 1
        ],
    ];
}
