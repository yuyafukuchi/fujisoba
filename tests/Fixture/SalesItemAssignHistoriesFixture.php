...
class SalesItemAssignHistoriesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'sales_item_id' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'menu_item_id' => 1,
            'sales_item_id' => 1,
            'start' => '2017-10-02 20:31:05',
            'end' => '2017-10-02 20:31:05',
            'created' => '2017-10-02 20:31:05',
            'created_by' => 1,
            'modified' => '2017-10-02 20:31:05',
            'modified_by' => 1
        ],
    ];
}
