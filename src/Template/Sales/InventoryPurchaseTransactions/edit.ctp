...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $inventoryPurchaseTransaction->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $inventoryPurchaseTransaction->id)]
            )
        ?></li>
...
<div class="inventoryPurchaseTransactions form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Inventory Purchase Transaction') ?></legend>
        <?php
