    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <?=$this->Form->create('StoreInventoryItemHistories',['url' => ['action' => 'edit','store' => $storeId, $storeInventoryItemHistory->id]]) ?>
                ...
                <?=$this->Form->end() ?>
                <td><?= $this->Form->postLink('削除', ['action' => 'delete', $storeInventoryItemHistory->id, 'store' => $storeId], ['confirm' => '削除しますか？']) ?></td>
                <td> </td>
            </tr>
            <?php $i ++ ; endforeach; ?>
        </tbody>
