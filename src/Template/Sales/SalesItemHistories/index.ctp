...
<div class="salesItemHistories index large-9 medium-8 columns content">
    マスタ出庫アイテム設定
    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $this->Html->link(__('Edit'), ['action' => 'edit', $salesItemHistory->id]) ?></td>
                <td> <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $salesItemHistory->id]) ?></td>
            </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
