...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $salesItemAssignHistory->id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $salesItemAssignHistory->id)]
            )
        ?></li>
...
<div class="salesItemAssignHistories form large-9 medium-8 columns content">
    ...
    <fieldset>
        <legend><?= __('Edit Sales Item Assign History') ?></legend>
        <?php
