...
class StoresController extends AppController
{
    ...
    public function view($id = null)
    {
        $store = $this->Stores->get($id, [
            'contain' => ['Companies', 'CashAccountTrans', 'Employees', 'InventoryPurchaseTransactions', 'SalesTransactions', 'StoreAccountInfos', 'StoreInventoryItemHistories', 'TimeCards', 'Users']
        ]);
    ...
    public function add()
    {
        ...
        $this->set(compact('store', 'companies'));
        $this->set('_serialize', ['store']);
    }
